...
class DriveApi {
  ...
  final clients.ApiRequester _requester;
  ...
  DriveApi(http.Client client, core.Map<core.String, core.String> authHeaders,
      {core.String rootUrl: "https://www.googleapis.com/",
      core.String servicePath: "drive/v3/"})
      : _requester = new clients.ApiRequester(
            client, rootUrl, servicePath, USER_AGENT, authHeaders);
}

class AboutResourceApi {
  final clients.ApiRequester _requester;

  AboutResourceApi(clients.ApiRequester client) : _requester = client;
  ...
  async.Future<About> get({core.String $fields}) {
    ...
    var _downloadOptions = requests.DownloadOptions.Metadata;
    var _body = null;
...
class ChangesResourceApi {
  ...
  ChangesResourceApi(clients.ApiRequester client) : _requester = client;
...
class ChannelsResourceApi {
  ...
  ChannelsResourceApi(clients.ApiRequester client) : _requester = client;
...
class CommentsResourceApi {
  ...
  CommentsResourceApi(clients.ApiRequester client) : _requester = client;
  ...
  async.Future<Comment> create(Comment request, core.String fileId,
    ...
    _url = 'files/' + clients.Escaper.ecapeVariable('$fileId') + '/comments';
  ...
  async.Future delete(core.String fileId, core.String commentId,
    ...
    _url = 'files/' +
        clients.Escaper.ecapeVariable('$fileId') +
        '/comments/' +
        clients.Escaper.ecapeVariable('$commentId');
...
class FilesResourceApi {
  ...
  FilesResourceApi(clients.ApiRequester client) : _requester = client;
  ...
  async.Future<File> copy(File request, core.String fileId,
    ...
    _url = 'files/' + clients.Escaper.ecapeVariable('$fileId') + '/copy';
  ...
  async.Future<File> create(File request,
      ...
      core.String $fields,
      requests.UploadOptions uploadOptions: requests.UploadOptions.Default,
      requests.Media uploadMedia}) {
    var _url = null;
    var _queryParams = new core.Map<core.String, core.List<core.String>>();
    var _uploadMedia = null;
    var _uploadOptions = null;
    ...
    if (_uploadMedia == null) {
      _url = 'files';
    } else if (_uploadOptions is requests.ResumableUploadOptions) {
  ...
  async.Future delete(core.String fileId,
    ...
    _url = 'files/' + clients.Escaper.ecapeVariable('$fileId');
  ...
  async.Future export(core.String fileId, core.String mimeType,
      {core.String $fields,
      requests.DownloadOptions downloadOptions:
          requests.DownloadOptions.Metadata}) {
    var _url = null;
    var _queryParams = new core.Map<core.String, core.List<core.String>>();
    var _uploadMedia = null;
    var _uploadOptions = null;
    ...
    _url = 'files/' + clients.Escaper.ecapeVariable('$fileId') + '/export';
    ...
    if (_downloadOptions == null ||
        _downloadOptions == requests.DownloadOptions.Metadata) {
      return _response.then((data) => null);
    } else {
      return _response;
    }
  ...
  async.Future<File> update(File request, core.String fileId,
    ...
    if (_uploadMedia == null) {
      ...
      _url =
          '/upload/drive/v3/files/' + clients.Escaper.ecapeVariable('$fileId');
    }
  ...
  async.Future watch(Channel request, core.String fileId,
    ...
    _url = 'files/' + clients.Escaper.ecapeVariable('$fileId') + '/watch';
...
class PermissionsResourceApi {
  ...
  PermissionsResourceApi(clients.ApiRequester client) : _requester = client;
  ...
  async.Future<Permission> create(Permission request, core.String fileId,
    ...
    _url = 'files/' + clients.Escaper.ecapeVariable('$fileId') + '/permissions';
  ...
  async.Future delete(core.String fileId, core.String permissionId,
    ...
    _url = 'files/' +
        clients.Escaper.ecapeVariable('$fileId') +
        '/permissions/' +
        clients.Escaper.ecapeVariable('$permissionId');
...
class RepliesResourceApi {
  ...
  RepliesResourceApi(clients.ApiRequester client) : _requester = client;
  ...
  async.Future delete(
    ...
    _url = 'files/' +
        ...
        clients.Escaper.ecapeVariable('$commentId') +
        '/replies/' +
        clients.Escaper.ecapeVariable('$replyId');
...
class RevisionsResourceApi {
  ...
  RevisionsResourceApi(clients.ApiRequester client) : _requester = client;
  ...
  async.Future delete(core.String fileId, core.String revisionId,
    ...
    _url = 'files/' +
        clients.Escaper.ecapeVariable('$fileId') +
        '/revisions/' +
        clients.Escaper.ecapeVariable('$revisionId');
  ...
  async.Future<RevisionList> list(core.String fileId,
    ...
    _url = 'files/' + clients.Escaper.ecapeVariable('$fileId') + '/revisions';
...
class TeamdrivesResourceApi {
  ...
  TeamdrivesResourceApi(clients.ApiRequester client) : _requester = client;
  ...
  async.Future delete(core.String teamDriveId, {core.String $fields}) {
    ...
    _url = 'teamdrives/' + clients.Escaper.ecapeVariable('$teamDriveId');
...
class About {
  ...
  About.fromJson(core.Map _json) {
    ...
    if (_json.containsKey("exportFormats")) {
      exportFormats = clients.mapMap<core.List, core.List<core.String>>(
    ...
    if (_json.containsKey("importFormats")) {
      importFormats = clients.mapMap<core.List, core.List<core.String>>(
